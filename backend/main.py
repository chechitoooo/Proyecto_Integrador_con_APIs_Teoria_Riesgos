...
from backend.models import orm  # noqa: registers Asset, Price, Portfolio
from backend.models.orm import PredictionLog  # noqa: ensure table registered
from backend.config import get_settings

from backend.routers.endpoints import (
    router_utils, router_tecnico, router_rendimientos, router_garch,
    router_capm, router_var, router_markowitz, router_senales,
    router_macro, router_renta_fija, router_opciones, router_stress, router_ml,
)
